...
class WithdrawSelectScreen extends StatefulWidget {
  const WithdrawSelectScreen({Key? key}) : super(key: key);

  @override
  State<WithdrawSelectScreen> createState() => _WithdrawSelectScreenState();
}

class _WithdrawSelectScreenState extends State<WithdrawSelectScreen>
    with Helpers {
  @override
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.pushNamed(context, '/withdraw_screen');
                      },
